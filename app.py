...
TCSGDR = update_ticker("https://www.google.com/finance/quote/TCSG:MCX")
VKCODR = update_ticker("https://www.google.com/finance/quote/VKCO:MCX")
...
def rumarket():
    ...
    return render_template("msk-market.html", time=dt.strftime('%d.%m.%Y %H:%M:%S'), LKOH=LKOH, GAZP=GAZP,
                           SBER=SBER, YNDX=YNDX, PHOR=PHOR, GMKN=GMKN, ROSN=ROSN, TCSGDR=TCSGDR, VKCODR=VKCODR,
